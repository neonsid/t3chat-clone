...
export const TOOLTIP_ANCHOR_TRANSLATE: Record<MotionSide, string> = {
  top: "-50% -100%",
  bottom: "-50% 0",
  left: "-100% -50%",
  right: "0 -50%",
}
export const TOOLTIP_TRANSFORM_ORIGIN: Record<MotionSide, string> = {
  top: "center bottom",
  bottom: "center top",
  left: "right center",
  right: "left center",
}
export const TOOLTIP_OFFSET_FROM: Record<
  MotionSide,
  { x?: number; y?: number }
> = {
  top: { y: 8 },
...
export const TABS_LIST_CLASSES: Record<TabsVariant, string> = {
